...
export const settingsTemplate = (): SettingSchemaDesc[] => [
  ...
  {// リファレンスに日付リンクを挿入するかどうか
    key: "DONErefAddLink",
    title: t("DONE task: ") + t("Add the journal link to the reference of the DONE task"),
    type: "boolean",
    default: true,
    description: "",
  },
  {// リファレンスに時間を挿入するかどうか
    key: "DONErefTime",
    title: t("DONE task: ") + t("Add time to the reference of the DONE task"),
    type: "boolean",
    default: true,
    description: "",
  },
  {// リファレンスに週番号を挿入するかどうか
    ...
    title: t("DONE task: ") + t("Add the week number to the reference of the DONE task"),
    type: "enum",
    default: "None",
  ...
  {//referenceにするかembedにするか
    key: "DONErefEmbed",
    title: t("DONE task: ") + t("Embed the reference of the DONE task"),
    type: "boolean",
    default: true,
    description: "",
  },
  ...
  {// リファレンスに日付リンクを挿入するかどうか
    key: "DOINGrefAddLink",
    title: t("DOING task: ") + t("Add the journal link to the reference of the DOING task"),
    type: "boolean",
    default: true,
    description: "",
  },
  {// リファレンスに時間を挿入するかどうか
    key: "DOINGrefTime",
    title: t("DOING task: ") + t("Add time to the reference of the DOING task"),
    type: "boolean",
    default: true,
    description: "",
  },
  {// リファレンスに週番号を挿入するかどうか
    ...
    title: t("DOING task: ") + t("Add the week number to the reference of the DOING task"),
    type: "enum",
    default: "None",
    enumChoices: ["None", "ISO8601", "US"],
    description: t("If you want to use the ISO8601 format, select `ISO8601`. If you want to use the US format, select `US`."),
  ...
  {//referenceにするかembedにするか
    key: "DOINGrefEmbed",
    title: t("DOING task: ") + t("Embed the reference of the DOING task"),
    type: "boolean",
    default: true,
    description: "",
  },
  ...
  {// 月ごとのソートをリンクにするかどうか
    key: "sortByMonthLink",
    title: t("Common: Link to the month"),
    type: "boolean",
    default: true,
    description: "",
  },
